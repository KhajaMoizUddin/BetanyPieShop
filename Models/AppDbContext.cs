...
namespace BetanyPieShop_coreMVC.Models
{
    public class AppDbContext : DbContext
    {
        ...
        //As there is no data in the database, below method can be used to insert data into database, 
        //we need to run another like add-migration AddedValues and update-database (AddedValues is any name of the migration).
